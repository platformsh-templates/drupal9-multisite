...
| [`config/sync/main/.gitkeep`](config/sync/main/.gitkeep) |    |
...
| [`web/sites/main/settings.php`](web/sites/main/settings.php) |    |
| [`web/sites/main/services.yml`](web/sites/main/services.yml) |    |
| [`web/sites/main/drushrc.php`](web/sites/main/drushrc.php) |    |
